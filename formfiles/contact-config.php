...
<!-- Start message -->
<p><strong>Hemos recibido su mensaje, responderemos en la mayor brevedad posible.</strong></p>
<!-- End message -->
EOD;
...
$subject = array('Asunto','subject',NULL,NULL);
